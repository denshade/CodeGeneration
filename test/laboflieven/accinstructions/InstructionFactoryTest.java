...
class InstructionFactoryTest {
    ...
    void createInstruction() {
        ...
        assertEquals("laboflieven.instructions.accinstructions.Pow", fact.createInstruction(new laboflieven.common.AccInstructionOpcode(AccInstructionOpcodeEnum.Pow)).getClass().getCanonicalName());
