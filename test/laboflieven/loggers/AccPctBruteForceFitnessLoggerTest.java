...
class AccPctBruteForceFitnessLoggerTest {
    ...
    @Test
    void addFitness() {
        AccPctBruteForceFitnessLogger logger = new AccPctBruteForceFitnessLogger(new AccInstructionOpcode[]{AccInstructionOpcode.Mod, AccInstructionOpcode.AccLeftPull}, 1000, 2);
    ...
    void bigProgram()
    {
        AccPctBruteForceFitnessLogger logger = new AccPctBruteForceFitnessLogger(new AccInstructionOpcode[]{AccInstructionOpcode.Mod, AccInstructionOpcode.AccLeftPull, AccInstructionOpcode.Nand}, 1000, 2);
