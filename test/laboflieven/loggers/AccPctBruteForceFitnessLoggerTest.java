...
class AccPctBruteForceFitnessLoggerTest {
    ...
    @Test
    void addFitness() {
        AccPctBruteForceFitnessLogger logger = new AccPctBruteForceFitnessLogger(new AccInstructionSet[]{AccInstructionSet.Mod, AccInstructionSet.AccLeftPull}, 1000, 2);
    ...
    void bigProgram()
    {
        AccPctBruteForceFitnessLogger logger = new AccPctBruteForceFitnessLogger(new AccInstructionSet[]{AccInstructionSet.Mod, AccInstructionSet.AccLeftPull, AccInstructionSet.Nand}, 1000, 2);
