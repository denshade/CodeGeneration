...
{
    private final double saturatedMax;
    ...
    private final int temperatureRaiser;
    ...
    {
        return iterate(1000000, config.getMaxNrInstructions(10), config.getNamingScheme().createRegisters(config.getNumberOfRegisters(2)), config.getFitnessExaminer(), config.getStopAtSolution(true));
    }
