...
public class VectAdd extends NoRegisterInstruction {

    @Override
    public InstructionOpcode getInstructionOpcode() {
        return new laboflieven.common.AccInstructionOpcode(AccInstructionOpcodeEnum.VectAdd);
    }
    ...
    public Integer execute(Register left, Register right, VectorRegister leftVect, VectorRegister rightVect, int ip) {
        VectorElementWiseBinary.applyInPlaceLeft(leftVect, rightVect, Double::sum);
        return null;
    }
